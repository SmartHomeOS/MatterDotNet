...
namespace MatterDotNet.Clusters.MeasurementAndSensing
{
    ...
    public class PM10ConcentrationMeasurement : ClusterBase
    {
        internal const uint CLUSTER_ID = 0x042d;

        /// <summary>
        /// Attributes for reporting PM10 concentration measurements
        /// </summary>
        [SetsRequiredMembers]
        public PM10ConcentrationMeasurement(ushort endPoint) : this(CLUSTER_ID, endPoint) { }
        /// <inheritdoc />
        [SetsRequiredMembers]
        protected PM10ConcentrationMeasurement(uint cluster, ushort endPoint) : base(cluster, endPoint) {
        ...
        public override string ToString() {
            return "PM10 Concentration Measurement";
        }
    }
}