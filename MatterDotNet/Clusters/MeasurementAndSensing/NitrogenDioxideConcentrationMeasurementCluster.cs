...
namespace MatterDotNet.Clusters.MeasurementAndSensing
{
    ...
    public class NitrogenDioxideConcentrationMeasurement : ClusterBase
    {
        internal const uint CLUSTER_ID = 0x0413;

        /// <summary>
        /// Attributes for reporting nitrogen dioxide concentration measurements
        /// </summary>
        public NitrogenDioxideConcentrationMeasurement(ushort endPoint) : base(CLUSTER_ID, endPoint) { }
        /// <inheritdoc />
        protected NitrogenDioxideConcentrationMeasurement(uint cluster, ushort endPoint) : base(cluster, endPoint) { }
        ...
        public override string ToString() {
            return "Nitrogen Dioxide Concentration Measurement";
        }
    }
}