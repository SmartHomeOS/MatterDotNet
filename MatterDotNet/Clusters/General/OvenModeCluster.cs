...
namespace MatterDotNet.Clusters.General
{
    ...
    public class OvenMode : ClusterBase
    {
        ...
        /// </summary>
        [SetsRequiredMembers]
        public OvenMode(ushort endPoint) : this(CLUSTER_ID, endPoint) { }
        /// <inheritdoc />
        [SetsRequiredMembers]
        protected OvenMode(uint cluster, ushort endPoint) : base(cluster, endPoint) {
