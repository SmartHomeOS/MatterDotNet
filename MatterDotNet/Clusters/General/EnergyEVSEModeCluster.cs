...
namespace MatterDotNet.Clusters.General
{
    ...
    public class EnergyEVSEMode : ClusterBase
    {
        ...
        /// </summary>
        [SetsRequiredMembers]
        public EnergyEVSEMode(ushort endPoint) : this(CLUSTER_ID, endPoint) { }
        /// <inheritdoc />
        [SetsRequiredMembers]
        protected EnergyEVSEMode(uint cluster, ushort endPoint) : base(cluster, endPoint) {
        ...
        public enum ModeTag : ushort {
            ...
            Manual = 0x4000,
            /// <summary>
            /// While in modes with this tag, and once enabled with the EnableCharging command, the EVSE will attempt to automatically start charging based on the user’s charging targets.
            /// </summary>
            TimeOfUse = 0x4001,
            /// <summary>
