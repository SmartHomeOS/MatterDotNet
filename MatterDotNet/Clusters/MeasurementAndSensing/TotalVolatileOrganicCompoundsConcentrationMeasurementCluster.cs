...
namespace MatterDotNet.Clusters.MeasurementAndSensing
{
    ...
    public class TotalVolatileOrganicCompoundsConcentrationMeasurement : ClusterBase
    {
        internal const uint CLUSTER_ID = 0x042e;

        /// <summary>
        /// Attributes for reporting total volatile organic compounds concentration measurements
        /// </summary>
        [SetsRequiredMembers]
        public TotalVolatileOrganicCompoundsConcentrationMeasurement(ushort endPoint) : this(CLUSTER_ID, endPoint) { }
        /// <inheritdoc />
        [SetsRequiredMembers]
        protected TotalVolatileOrganicCompoundsConcentrationMeasurement(uint cluster, ushort endPoint) : base(cluster, endPoint) {
        ...
        public override string ToString() {
            return "Total Volatile Organic Compounds Concentration Measurement";
        }
    }
}