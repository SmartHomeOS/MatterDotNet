...
namespace MatterDotNet.Clusters.General
{
    ...
    public class LaundryWasherMode : ClusterBase
    {
        internal const uint CLUSTER_ID = 0x0051;

        /// <summary>
        /// Attributes and commands for selecting a mode from a list of supported options.
        /// </summary>
        [SetsRequiredMembers]
        public LaundryWasherMode(ushort endPoint) : this(CLUSTER_ID, endPoint) { }
        /// <inheritdoc />
        [SetsRequiredMembers]
        protected LaundryWasherMode(uint cluster, ushort endPoint) : base(cluster, endPoint) {
