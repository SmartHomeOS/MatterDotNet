...
namespace MatterDotNet.Clusters.MeasurementAndSensing
{
    ...
    public class RadonConcentrationMeasurement : ClusterBase
    {
        internal const uint CLUSTER_ID = 0x042f;

        /// <summary>
        /// Attributes for reporting radon concentration measurements
        /// </summary>
        [SetsRequiredMembers]
        public RadonConcentrationMeasurement(ushort endPoint) : this(CLUSTER_ID, endPoint) { }
        /// <inheritdoc />
        [SetsRequiredMembers]
        protected RadonConcentrationMeasurement(uint cluster, ushort endPoint) : base(cluster, endPoint) {
        ...
        public override string ToString() {
            return "Radon Concentration Measurement";
        }
    }
}